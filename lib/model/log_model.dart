...
import 'display_games_model.dart';
...
/*
{
  "gameLog": {
    ...
    "updateDate": 1672332230643,
    "startDate": 1672261200000,
    "stopDate": 1672434000000,
...
*/
  ...
  LogModel.fromJson(Map<String, dynamic> json) {
    gameLog = (json['gameLog'] != null) ? NewsFromFriendsLog.fromJson(json['gameLog']) : null;
    game = (json['game'] != null) ? GameModel.fromJson(json['game']) : null;
  }
  Map<String, dynamic> toJson() {
    final data = <String, dynamic>{};
    if (gameLog != null) {
      data['gameLog'] = gameLog!.toJson();
    }
    if (game != null) {
